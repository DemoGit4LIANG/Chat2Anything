...
- 包含客户端(Chat2Anything)与后台管理系统(Chat2Anything Admin)，其中后台管理系统负责大模型知识库的创建与管理，通过Langchain机制向大模型添加企业内部知识；管理系统包含完整的用户权限、角色、组织、数据字典管理等功能
...
- 数据库接入，收到/自动选择查询分析涉及的表，Text2SQL(待完善)，查询结果可视化(待开发)
  ...
  <img src="assets/admin_demo.gif" width="40%"/>
