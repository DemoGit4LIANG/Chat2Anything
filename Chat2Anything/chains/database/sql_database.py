...
class SQLDatabase:
    ...
    def open_session_with_db(self, db_name):
...
if __name__ == '__main__':
    local_db: SQLDatabase = SQLDatabase.from_uri(
        "mysql+pymysql://"
        + "root"
        + ":"
        + "mysql8"
    ...
    # print(local_db.get_usable_table_names())
    # print(local_db.get_database_list())
    # print(local_db.get_table_comments('chat2db'));
    sessoion = local_db.get_session('chat2db')
    print('---------------')
    print(local_db.table_simple_info(sessoion))
    print(local_db.get_usable_table_names())
    # print(local_db.get_usable_table_names())
    # print(local_db.table_info)